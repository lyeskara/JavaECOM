...
public class ProductRepository {
	...
	static {
        ...
        products.add(new Product("M5", "World class car", "BMW", "1", "A", 250000.0));
        products.add(new Product("AMG-GT", "World class car", "Mercedes", "2", "B", 350000.0));
        products.add(new Product("7 series", "World class car", "BMW", "3", "C", 150000.0));
        products.add(new Product("S-class", "World class car", "BMW", "4", "D", 100000.0));
        products.add(new Product("Maybach", "World class car", "Mercedes", "5", "E", 450000.0));
	}
	...
	public static void CreateProduct(String sku,String name) {
        ...
        products.add(new Product(name, "No description added", "No vendor mentioned", urlSlug , sku, 0.0));
    }
